export default function dashboard(updateHandlerUrl, generateUrl, modelsUrl, initialAvailableApis, defaultHandler) {
    return {
        ...
        async openConfigModal(provider) {
        ...
        async openChangeDefaultModelModal(provider) {
            ...
            if (this.$refs.defaultModelSelect) {
                this.$refs.defaultModelSelect.focus();
            }
        },

        async openChangeModelModal(provider) {
            this.modalProvider = provider;
            await this.fetchModelsIfNeeded(provider);
        ...
        async openTestModal(provider, prompt = null) {
            ...
            if (this.$refs.testPromptInput) {
                this.$refs.testPromptInput.focus();
            }
        },

        async openDeletePromptModal(key) {
            this.promptToDeleteKey = key;
            this.activeModal = 'deletePrompt';
        },

        openDeleteApiKeyModal(provider) {
